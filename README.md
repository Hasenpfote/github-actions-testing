...
[2022/12/07] [ドキュメント](https://python-poetry.org/docs/#system-requirements) より
...
importlib-metadata = { version = "^5.1.0", python = "~3.7" }
pytest = "^6.1.2"
tox = "^3.20.1"
```

**[2022/12/07] pytest は python 3.7 以上を対象としているが,  3.7 では importlib-metadata を必要とする.**
